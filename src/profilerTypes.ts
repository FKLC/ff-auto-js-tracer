// Amalgamation of https://github.com/firefox-devtools/profiler/blob/main/src/types/*.js
// Yes there are missing types, but we only really care for the types that are used by
// this project, add more as needed.
...
export type LibMapping = {
  ...
  debugName: string
  // e.g. "firefox", or "firefox.pdb" on Windows
  debugPath: string
  // e.g. "/Applications/FirefoxNightly.app/Contents/MacOS/firefox"
  breakpadId: string
 ...
 */
export type ProcessProfilingLog = Record<string, unknown>
 ...
 * This type might also change in the future without warning.
 */
export type ProfilingLog = Record<number, ProcessProfilingLog>
